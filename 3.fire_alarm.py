...
class House:
    ...
    def fireAlarm(self):
        ...
        for x in range(len(self.elevators)):
            
            self.driveElevator(x, self.HouseLowFloor)
        print('\nAll elevators at lowest floor.\n')
            
            
house1 = House(10,1,4)

house1.driveElevator(1, 7)
house1.driveElevator(2, 6)
house1.driveElevator(3, 9)
house1.driveElevator(4, 8)
